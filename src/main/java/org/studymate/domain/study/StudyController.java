...
public class StudyController {
	...
	public ResponseEntity<?> handleStudyList(@RequestAttribute Long userId) {
		...
		List<Study> list = studyService.getStudyListByUser(userId);
	...
	public ResponseEntity<?> handleCreateStudy(@RequestAttribute Long userId,
		...
		String studyId = studyService.addStudy(userId, createStudyRequest);
...
//		log.debug("list size {}", list.size());
		...
		return new ResponseEntity<>(Map.of("status", "Ok", "notice", list), HttpStatus.OK);
	}
